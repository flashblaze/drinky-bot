/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 0dbc5a6fcb4c2393debc0d6828686d54)
// Runtime types generated with workerd@1.20260128.0 2026-01-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DrinkyState";
	}
	interface Env {
		BOT_TOKEN: string;
		MODE: string;
		DRINKY_STATE: DurableObjectNamespace<import("./src/index").DrinkyState>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_TOKEN" | "MODE">> {}
}
