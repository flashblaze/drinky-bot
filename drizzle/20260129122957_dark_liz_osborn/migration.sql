...
INSERT INTO `__new_user`(`id`, `telegramId`, `firstName`, `lastName`, `username`, `languageCode`, `goal`, `reminderEnabled`, `reminderIntervalMinutes`, `reminderTimezone`, `createdAt`, `updatedAt`) SELECT `id`, `telegramId`, `firstName`, `lastName`, `username`, `languageCode`, `goal`, `reminderEnabled`, `reminderIntervalMinutes`, `reminderTimezone`, `createdAt`, `updatedAt` FROM `user`;--> statement-breakpoint
